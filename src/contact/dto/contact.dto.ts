...
import { IsEnum, IsString, IsNotEmpty, MinLength, MaxLength, IsOptional, IsInt, Length, Matches, ValidateNested, IsBoolean, IsArray, ArrayUnique } from 'class-validator';
...
export class ContactUserDto {
  ...
  @ApiPropertyOptional({
    description:
      'شناسه عنوان (مانند آقا، خانم، دکتر و ...). مقدار باید از جدول titles ارسال شود.',
    example: 1,
    nullable: true,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description:
      'شماره تلفن همراه کاربر. فرمت استاندارد ایران (مثال: 09121234567). در صورت ارسال باید معتبر و یکتا باشد.',
    example: '09121234567',
    nullable: true,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description:
      'کد اقتصادی (در صورت وجود برای اشخاص حقوقی یا حقیقی دارای فعالیت اقتصادی)',
...
export class ContactCompanyDto {
  ...
  @ApiProperty({
    ...
    enumName: 'OrganType',
    description:
      'نوع مالکیت شرکت (سهامی خاص، مسئولیت محدود، تعاونی و ...)',
  ...
  @ApiProperty({
    ...
    description:
      'نوع شخصیت حقوقی (حقیقی، حقوقی، مشارکت مدنی، اتباع خارجی و ...)',
  ...
  @ApiProperty({
    ...
    description:
      'وضعیت فعالیت شرکت (خصوصی، دولتی، هلدینگ، چندملیتی و ...)',
  ...
  @ApiPropertyOptional({
    description:
      'شناسه ملی شرکت (در صورت وجود). باید یکتا باشد.',
    example: '14001234567',
    minLength: 11,
    maxLength: 11,
  })
  ...
  @ApiPropertyOptional({
    description:
      'تاریخ ثبت شرکت (فرمت پیشنهادی: YYYY-MM-DD یا تاریخ شمسی استاندارد)',
    example: '2020-05-20',
  })
  @IsOptional()
  @IsString()
